...
INSERT INTO shiftrosterassignment (shift_id, roster_id, doassigned, role_id, employee_id, shiftrosterassignmentstatus_id) VALUES
                                                                                                                              (1, 4, '2026-03-23', 1, 1, 2), -- CONFIRMED
                                                                                                                              (1, 4, '2026-03-23', 2, 9, 2), -- CONFIRMED
                                                                                                                              (2, 4, '2026-03-23', 1, 2, 2); -- CONFIRMED

-- ==================== DATA SUMMARY ====================
-- Branch 1 (Colombo Head Office) now has:
-- - 3 active shifts (Morning, Evening, Night) - 8 hours each
-- - 2 roles (Driver, Conductor)
-- - 12 qualified ACTIVE drivers (employees: 1,2,3,4,5,21,22,26,27,28,29,30)
-- - 10 qualified ACTIVE conductors (employees: 9,11,14,20,31,32,33,34,35)
-- - All employees belong to Branch 1
-- - All employees have ACTIVE status (employeestatus_id = 1)
-- - All crew have ELIGIBLE/ACTIVE status (crewstatus_id = 1 or 3)
-- - All medical/license dates are valid and future
--
-- Total assignments needed for 1 week: 3 shifts × 2 roles × 7 days = 42 assignments
-- Available resources: 12 drivers + 10 conductors = 22 employees
-- Average workload: 42 assignments / 22 employees = 1.9 assignments per person
-- Average hours per employee: ~16 hours per week (well under 48-hour limit)
--
-- This ensures OptaPlanner can generate a feasible solution with:
-- - 0hard constraint violations (all hard constraints satisfied)
-- - Optimal soft score (balanced workload, minimal overtime)
...
--
-- -- Rosters for testing
-- -- Roster 1: DRAFT with suggestions (for UAT 1, 5, 7, 9, 10, 11, 16, 17)
-- --INSERT INTO roster (branch_id, dostartofweek, doendofweek, rosterstatus_id, deleted) VALUES
--   --  (1, '2026-03-02', '2026-03-08', 1, 0);
--
-- -- data_roster_uat.sql
--
-- -- Roster 1: DRAFT (for overlap testing)
-- INSERT INTO roster (branch_id, dostartofweek, doendofweek, rosterstatus_id, deleted) VALUES
--     ( 1, '2026-03-02', '2026-03-08', 1, 0);  -- Week 1
--
-- -- Roster 2: LOCKED with mixed confirmations (for UAT 6, 13, 15, 19)
-- INSERT INTO roster (branch_id, dostartofweek, doendofweek, rosterstatus_id, deleted) VALUES
--     (1, '2026-03-09', '2026-03-15', 2, 0);
...
-- INSERT INTO shiftrosterassignment (shift_id, roster_id, doassigned, role_id, employee_id, shiftrosterassignmentstatus_id) VALUES
--           (1, 1, '2026-03-02', 1, 1, 1), -- Morning Driver (for UAT 9 - approve)
--           (1, 1, '2026-03-02', 2, 6, 1), -- Morning Conductor (for UAT 10 - reject)
--           (2, 1, '2026-03-02', 1, 2, 1); -- Evening Driver
--
-- -- Assignments for Roster 2 (LOCKED, mixed)
-- INSERT INTO shiftrosterassignment (shift_id, roster_id, doassigned, role_id, employee_id, shiftrosterassignmentstatus_id) VALUES
--           (1, 2, '2026-03-09', 1, 1, 2), -- CONFIRMED
--           (1, 2, '2026-03-09', 2, 6, 1), -- SUGGESTED (for UAT 15 - blocks archival)
--           (2, 2, '2026-03-09', 1, 2, 2); -- CONFIRMED
--
-- -- Assignments for Roster 4 (ALL CONFIRMED for archival)
-- INSERT INTO shiftrosterassignment (shift_id, roster_id, doassigned, role_id, employee_id, shiftrosterassignmentstatus_id) VALUES
--           (1, 4, '2026-03-23', 1, 1, 2), -- CONFIRMED
--           (1, 4, '2026-03-23', 2, 6, 2), -- CONFIRMED
--           (2, 4, '2026-03-23', 1, 2, 2); -- CONFIRMED
