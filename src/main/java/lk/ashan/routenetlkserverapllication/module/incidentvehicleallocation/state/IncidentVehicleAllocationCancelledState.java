...
@Component
public class IncidentVehicleAllocationCancelledState implements IncidentVehicleAllocationState {
    @Override
    public void transitionTo(IncidentVehicleAllocation allocation, IncidentVehicleAllocationStatus newStatus) {
        throw new InvalidStateTransitionException("Cannot transition from CANCELLED state");
    }
}
