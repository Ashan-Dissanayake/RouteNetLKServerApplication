...
public class VehicleRequestDto {
    ...
    @NotBlank(message = "Seating Capacity Can Not be Empty")
    ...
    @Pattern(regexp = "(^[A-Z0-9]{12}$)|(^[0-9]{1}[A-Z]{2}\\-[A-Z0-9]{4}\\-[A-Z]{1}\\-[0-9]{5}$)|(^[A-Z0-9]{3}[0-9]{3}[A-Z0-9]{5}$)|(^[A-Z]{2}[0-9]{3}[A-Z]{2}\\.[0-9]{6}$)\n",
