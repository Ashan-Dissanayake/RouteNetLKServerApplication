...
public interface TripExecutionMapper {
    ...
    // 1. Map JPA TripExecution to Planning Entity
    ...
    // 3. Driver Entity -> CrewFact (Includes licenseCategory)
