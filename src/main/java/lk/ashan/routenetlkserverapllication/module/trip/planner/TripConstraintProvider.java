...
public class TripConstraintProvider implements ConstraintProvider {
    ...
    private Constraint vehicleNotInUseAtSameTime(ConstraintFactory factory) {
        return factory.forEachUniquePair(TripVehicleOverRidePlanning.class,
                        Joiners.equal(TripVehicleOverRidePlanning::getAssignedVehicle),
                        Joiners.overlapping(
    ...
    private Constraint vehicleMustBeAvailable(ConstraintFactory factory) {
        return factory.forEach(TripVehicleOverRidePlanning.class)
                .filter(a -> {
