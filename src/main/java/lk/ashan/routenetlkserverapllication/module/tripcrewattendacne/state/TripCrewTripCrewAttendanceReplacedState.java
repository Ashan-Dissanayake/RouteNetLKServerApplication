...
@Component
public class TripCrewTripCrewAttendanceReplacedState implements TripCrewAttendanceState {

    private static final List<String> ALLOWED = List.of("PRESENT", "ABSENT");
    ...
    public void transitionTo(TripCrewAttendance attendance, CrewAttendanceStatus newStatus) {
        ...
        if (!ALLOWED.contains(target)) {
            throw new InvalidStateTransitionException(
                    "Invalid transition from REPLACED  to " + target
            );
        }
